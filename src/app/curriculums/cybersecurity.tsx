...
function Overview({ setView, openChapter, read, quizScores }) {
  ...
  return (
    <div className="curriculum-overview" style={{ maxWidth: 980, margin: "0 auto", padding: "0 16px 60px" }}>
      <CurriculumHero eyebrow="Defense path" title="Cybersecurity" description="A layered route from trust boundaries and cryptography to detection, response, and resilient operations." icon="🔒" color="#34D399" secondaryColor="#F87171" parts={PARTS.length} chapters={CHAPTERS.length} terms={GLOSSARY.length} signal="Identity → detection → resilience" nodes={["TLS", "IAM", "SOC", "IR", "Zero"]} />
